...
import QuestionRegister from "@/component/QuestionRegister.vue";
import QuestionRealEstate from "@/component/QuestionRealEstate.vue";
import QuestionFinancial from "@/component/QuestionFinancial.vue";
import QuestionSupport from "@/component/QuestionSupport.vue";
import QuestionSecurity from "@/component/QuestionSecurity.vue";
import { ref } from "vue";

let selectedIcon = ref("QuestionRegister");
</script>
...
.questions-faq-list
    ...
    .questions__section 
        ...
        QuestionFinancial(v-if="selectedIcon === 'QuestionFinancial'")
        QuestionSupport(v-if="selectedIcon === 'QuestionSupport'")
        QuestionSecurity(v-if="selectedIcon === 'QuestionSecurity'")
</template>
